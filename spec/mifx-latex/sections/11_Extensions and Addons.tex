...
Extensions provide additional metadata attached directly to an object.

Extensions are embedded within the JSON object using the \texttt{extensions} field.
...
Extensions may contain any JSON structure.
...
Addons provide larger or more structured extensions stored as separate JSON resources.

Addons are placed inside the \texttt{addons} directory associated with a specific object.
...
Addons are implicitly associated with the object directory in which they reside.
