...
Tool objects are stored within the \texttt{tools} directory and may be organized into tool groups.
...
The identifier is used by operations to reference the tool.
...
Profile definitions are typically stored as JSON objects referenced by the tool.
...
These values may correspond to controller parameters such as tool length compensation.
